...
def preprocess(data):
	...
	for eachline in data:
		...
		#print "RAW FIELD BELOW"		
		#print fields
		#sanity check //added port info. and flag info Has to be changed if tshark options are changed
		if len(fields) != 17 and (not(fields[8] == '1' or fields[9] == '1')):
			continue
		...
		if udppayload != '':
			...
			if fields[5] == '0':
				continue
		#ignore packet if both tcp and udp payload lengths are null #removed to incoporate syn/fin
		#elif payload == '' or tcppayload == '0':
		#	continue
